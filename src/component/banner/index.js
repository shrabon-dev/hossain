        ...
        <div className='container lg:py-28 sm_mobile:py-28 relative '>
            <div className='flex justify-between tablet:flex-row sm_mobile:flex-col-reverse items-center'>
                <div className='md:w-1/2 tablet:w-2/3 sm_mobile:w-full tablet:text-left sm_mobile:text-center'>
                    ...
                    <div className='flex items-center space-x-10 tablet:mt-10 sm_mobile:mt-0 tablet:justify-start sm_mobile:justify-center'>
                ...
                <div className='md:w-1/2  tablet:w-1/2 sm_mobile:w-1/2 text-right flex justify-end relative'>
                    ...
                    <span className='absolute moveTop tablet:top-52 sm_mobile:bottom-0 lg:-left-10 md:-left-32 sm_mobile:left-0 tablet:w-1/2 sm_mobile:w-full'>
                        <picture>
