    ...
    <>
        <div>
            <div className='container py-20 overflow-hidden'>
                ...
                {/* Section Heading End */}
                            <h6  className='font-poppin tablet:text-4xl sm_mobile:text-2xl sm_mobile:leading-relaxed mb-2 text-gray-300 font-normal leading-relaxed text-center tablet:w-1/2 m-auto'> <span className='text-active'>Hossain.</span> - A digital agency. You will get all best solution from here.</h6>
                <div className='tablet:flex justify-between tablet:py-32 sm_mobile:py-10 gap-5'>
                    <div className='tablet:w-1/2 sm_mobile:w-full'>
                        ...
                        relative after:w-0 after:duration-700 after:ease-in-out after:origin-top hover:after:w-[93%] after:h-3/4 after:bg-active after:absolute after:top-1/2 after:left-4 z-10 after:-z-10 after:rounded-full after:-translate-y-1/2'>
                            <span className='w-20 h-20 bg-active group-hover:bg-main_color duration-700 ease-in-out rounded-full flex justify-center items-center '> <HiOutlineMail className='inline-block text-6xl text-gray-100'/> </span>
                                <p className='font-poppin tablet:text-lg sm_mobile:text-base text-gray-300 font-normal'>hossain@gmail.com <span className='block pt-1'>info@gmail.com</span></p>
                        </div>
                        <div className='flex tablet:w-3/4 sm_mobile:w-full mb-9 justify-start gap-5 group items-center bg-2nd_color p-3 rounded-full 
                        relative after:w-0 after:duration-700 after:ease-in-out after:origin-top hover:after:w-[93%] after:h-3/4 after:bg-active after:absolute after:top-1/2 after:left-4 z-10 after:-z-10 after:rounded-full after:-translate-y-1/2'>
                            <span className='w-20 h-20 bg-active group-hover:bg-main_color duration-700 ease-in-out rounded-full flex justify-center items-center '> <IoCallSharp className='inline-block text-6xl text-gray-100'/> </span>
                                <p className='font-poppin tablet:text-lg sm_mobile:text-base text-gray-300 font-normal'>+880 1236547819 <span className='block pt-1'>+880 1425639871</span></p>
                        </div>
                        <div className='flex tablet:w-3/4 sm_mobile:w-full mb-9 justify-start gap-5 group items-center bg-2nd_color p-3 rounded-full 
                        relative after:w-0 after:duration-700 after:ease-in-out after:origin-top hover:after:w-[93%] after:h-3/4 after:bg-active after:absolute after:top-1/2 after:left-4 z-10 after:-z-10 after:rounded-full after:-translate-y-1/2'>
                            <span className='w-20 h-20 bg-active group-hover:bg-main_color duration-700 ease-in-out rounded-full flex justify-center items-center '> <IoLogoWhatsapp className='inline-block text-6xl text-gray-100'/> </span>
                            <p className='font-poppin tablet:text-lg sm_mobile:text-base text-gray-300 font-normal'>+999 56565826556 <span className='block pt-1'>+881 12365896541</span></p>
                        </div>
                        ...
                        relative after:w-0 after:duration-700 after:ease-in-out after:origin-top hover:after:w-[93%] after:h-3/4 after:bg-active after:absolute after:top-1/2 after:left-4 z-10 after:-z-10 after:rounded-full after:-translate-y-1/2'>
                            <span className='w-20 h-20 bg-active group-hover:bg-main_color duration-700 ease-in-out rounded-full flex justify-center items-center '> <IoLocationSharp className='inline-block text-6xl text-gray-100'/> </span>
                                <p className='font-poppin tablet:text-lg sm_mobile:text-base text-gray-300 font-normal'>Kashba Nama Para<span className='block pt-1'>Sherpu-Mymensingh</span></p>
                        </div>
                    ...
                    <div className='tablet:w-1/2 sm_mobile:w-full'>
                        ...
                        <form className='w-full m-auto bg-2nd_color p-6 rounded-md'>
                            <h6  className='font-poppin tablet:w-1/2 m-auto text-xl mb-10 uppercase border-b border-hover_color/75 pb-3 text-gray-300 font-normal leading-relaxed text-center'> <span className='text-active'>Get Touch With Us</span> </h6>
                            <div>
