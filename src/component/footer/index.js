            ...
            <div className='flex justify-between items-start'>
              <div className='tablet:w-1/2 sm_mobile:w-full '>
                <h5 className='font-poppin tablet:text-2xl sm_mobile:text-xs text-white pb-5 '>Important Links</h5>
                    <ul className='text-white flex-col space-y-6'>
                        <li><a className='a_css hover:bg-active hover:text-main_color' href='#'>Our works</a></li>
                        <li><a className='a_css hover:bg-active hover:text-main_color' href='#'>Pricing</a></li>
                        <li><a className='a_css hover:bg-active hover:text-main_color' href='#'>Faq's</a></li>
                        <li><a className='a_css hover:bg-active hover:text-main_color' href='#'>Contact</a></li>
                    </ul>
              </div>         
              <div className='tablet:w-1/2 sm_mobile:w-full tablet:pl-0 sm_mobile:pl-5'>
                    ...
                    <ul className='text-white flex flex-wrap tablet:space-x-3 sm_mobile:space-x-0 '>
                        <li><a className='before:bg-active tablet:mr-0 sm_mobile:mr-1 tablet:mb-0 sm_mobile:mb-2 tablet:w-12 tablet:h-12 sm_mobile:w-10 flex justify-center items-center sm_mobile:h-10 before:absolute tablet:before:w-12 sm_mobile:before:w-10 tablet:before:h-12 sm_mobile:before:h-10 before:z-[-2] before:block before:bottom-0 relative after:absolute after:bottom-0 after:z-[-1] z-[23] after:h-2 hover:text-main_color after:duration-300 duration-300 after:bg-white hover:after:h-full sm_mobile:hover:after:h-10 after:block tablet:after:w-12 sm_mobile:after:w-10 tablet:p-4 sm_mobile:p-3' href=''><FaLinkedinIn className='inline-block'/></a></li>
                        <li><a className='before:bg-active tablet:mr-0 sm_mobile:mr-1 tablet:mb-0 sm_mobile:mb-2 tablet:w-12 tablet:h-12 sm_mobile:w-10 flex justify-center items-center sm_mobile:h-10 before:absolute tablet:before:w-12 sm_mobile:before:w-10 tablet:before:h-12 sm_mobile:before:h-10 before:z-[-2] before:block before:bottom-0 relative after:absolute after:bottom-0 after:z-[-1] z-[23] after:h-2 hover:text-main_color after:duration-300 duration-300 after:bg-white hover:after:h-full sm_mobile:hover:after:h-10 after:block tablet:after:w-12 sm_mobile:after:w-10 tablet:p-4 sm_mobile:p-3' href=''><FaTwitter className='inline-block'/></a></li>
                        <li><a className='before:bg-active tablet:mr-0 sm_mobile:mr-1 tablet:mb-0 sm_mobile:mb-2 tablet:w-12 tablet:h-12 sm_mobile:w-10 flex justify-center items-center sm_mobile:h-10 before:absolute tablet:before:w-12 sm_mobile:before:w-10 tablet:before:h-12 sm_mobile:before:h-10 before:z-[-2] before:block before:bottom-0 relative after:absolute after:bottom-0 after:z-[-1] z-[23] after:h-2 hover:text-main_color after:duration-300 duration-300 after:bg-white hover:after:h-full sm_mobile:hover:after:h-10 after:block tablet:after:w-12 sm_mobile:after:w-10 tablet:p-4 sm_mobile:p-3' href=''><FaYoutube className='inline-block'/></a></li>
                        <li><a className='before:bg-active tablet:mr-0 sm_mobile:mr-1 tablet:mb-0 sm_mobile:mb-2 tablet:w-12 tablet:h-12 sm_mobile:w-10 flex justify-center items-center sm_mobile:h-10 before:absolute tablet:before:w-12 sm_mobile:before:w-10 tablet:before:h-12 sm_mobile:before:h-10 before:z-[-2] before:block before:bottom-0 relative after:absolute after:bottom-0 after:z-[-1] z-[23] after:h-2 hover:text-main_color after:duration-300 duration-300 after:bg-white hover:after:h-full sm_mobile:hover:after:h-10 after:block tablet:after:w-12 sm_mobile:after:w-10 tablet:p-4 sm_mobile:p-3' href=''><FaFacebookF className='inline-block'/></a></li>
                    </ul>
              </div>
              <div className='tablet:w-1/2 sm_mobile:w-full'>
