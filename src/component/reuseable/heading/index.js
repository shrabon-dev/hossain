  ...
  return (
    <>
        <div className='text-center tablet:w-1/3 sm_mobile:w-full m-auto tablet:pb-32 sm_mobile:pb-14 relative z-10'>
                ...
                {/* text shape */}
                <span className='font-poppin tablet:text-[200px] sm_mobile:text-[56px] -translate-x-1/2 -translate-y-1/2 tracking-wide text-stroke text-transparent font-bold absolute  top-1/4 left-1/2 z-[-1]'>{props.waterMark}</span>        
        </div>
    </>
  )
}
